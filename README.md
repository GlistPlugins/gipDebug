...
### 1. Create a Debug Build Configuration
...
4. Select the existing **Debug** configuration and click **Delete**
5. Click **New...**
6. Set both **Name** and **Description** to: `Debug`
7. Under **Copy settings from**, select **Existing configuration**
8. From the dropdown next to it, select **Release**
9. Click **OK**, then **OK** again to close the dialogs

### 2. Add GDB to Your Project's PATH
...
4. Double-click **PATH** and add the path above to the end of your existing PATH variable

### 3. Create a Debug Run Configuration
